...
from sdfl_api.models.vgg import SlimmableVGG16
from sdfl_api.models.vgg import SlimmableVGG11
from sdfl_api.models.resnet_9 import SlimmableResNet9, SlimmableResNet9_tinyimagenet
...
class AdaptiveflAPI():
    ...
    def create_model(self, model_name):
        ...
        if model_name == "resnet18":
            model = SlimmableResNet18(num_classes=self.args.n_classes)
        elif model_name == 'vgg16':
            model = SlimmableVGG16(num_classes=self.args.n_classes, dataset=self.args.dataset)
        elif model_name == 'vgg11':
            model = SlimmableVGG11(num_classes=self.args.n_classes, dataset=self.args.dataset)
        elif model_name == 'resnet9' and self.args.dataset != 'tinyimagenet':
            model = SlimmableResNet9(num_classes=self.args.n_classes)
        elif model_name == 'resnet9' and self.args.dataset == 'tinyimagenet':
            model = SlimmableResNet9_tinyimagenet(num_classes=self.args.n_classes)
        return model
    ...
    def train(self):
        ...
        for round_idx in range(self.args.comm_round):
            ...
            for clnt_id in activate_clients:
                ...
                w_local_mdl = self.client_list[clnt_id].train(copy.deepcopy(local_model), mask,
                                                                                 round_idx,
